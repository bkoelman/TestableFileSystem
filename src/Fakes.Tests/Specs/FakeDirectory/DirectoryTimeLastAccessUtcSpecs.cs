...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeDirectory
{
    public sealed class DirectoryTimeLastAccessUtcSpecs
    {
        ...
        [Fact, InvestigateRunOnFileSystem]
        private void When_getting_last_access_time_in_UTC_for_directory_below_missing_network_share_it_must_fail()
        {
            // Arrange
        ...
        [Fact, InvestigateRunOnFileSystem]
        private void When_setting_last_access_time_in_UTC_for_directory_below_missing_network_share_it_must_fail()
        {
            // Arrange
            const string path = @"\\ServerName\ShareName\missing";

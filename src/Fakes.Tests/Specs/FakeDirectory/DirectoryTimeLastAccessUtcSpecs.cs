...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeDirectory
{
    public sealed class DirectoryTimeLastAccessUtcSpecs
    {
        ...
        private void When_getting_last_access_time_in_UTC_for_invalid_drive_it_must_fail()
        {
            ...
            // Act
            Action action = () => fileSystem.Directory.GetLastAccessTimeUtc("_:");
        ...
        private void When_setting_last_access_time_in_UTC_for_invalid_drive_it_must_fail()
        {
            ...
            // Act
            Action action = () => fileSystem.Directory.SetLastAccessTimeUtc("_:", DefaultTimeUtc);
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_getting_last_access_time_in_UTC_for_directory_below_missing_network_share_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_setting_last_access_time_in_UTC_for_directory_below_missing_network_share_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange

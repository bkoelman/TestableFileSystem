...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeDirectory
{
    public sealed class DirectoryTimeCreationUtcSpecs
    {
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_getting_creation_time_in_UTC_for_directory_below_missing_network_share_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_setting_creation_time_in_UTC_for_directory_below_missing_network_share_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_setting_creation_time_in_UTC_for_existing_network_share_it_must_succeed(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange

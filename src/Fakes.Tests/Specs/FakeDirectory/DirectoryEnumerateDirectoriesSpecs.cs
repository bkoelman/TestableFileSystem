...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeDirectory
{
    public sealed class DirectoryEnumerateDirectoriesSpecs
    {
        [Theory]
        [CanRunOnFileSystem]
        private void When_enumerating_directories_for_null_path_it_must_fail(bool useFakes)
        {
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_enumerating_directories_for_empty_string_path_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_enumerating_directories_for_whitespace_path_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        private void When_enumerating_directories_for_invalid_drive_path_it_must_fail()
        {
            // Arrange
            ...
            // Act
            Action action = () => fileSystem.Directory.EnumerateDirectories("_:");
        ...
        [Fact, InvestigateRunOnFileSystem]
        private void When_enumerating_directories_for_wildcard_characters_in_path_it_must_fail()
        {
            // Arrange
            IFileSystem fileSystem = new FakeFileSystemBuilder()
                .Build();
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_enumerating_directories_for_null_pattern_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        private void When_enumerating_directories_for_pattern_that_contains_parent_directory_with_asterisk_it_must_fail()
        {
            ...
            // Act
            Action action = () => fileSystem.Directory.EnumerateDirectories(@"c:\folder", pattern);
        ...
        private void When_enumerating_directories_for_pattern_that_contains_parent_directory_with_question_it_must_fail()
        {
            ...
            // Act
            Action action = () => fileSystem.Directory.EnumerateDirectories(path, pattern);
        ...
        [Fact, InvestigateRunOnFileSystem]
        private void When_enumerating_directories_for_pattern_that_contains_forbidden_characters_it_must_fail()
        {
            // Arrange
            IFileSystem fileSystem = new FakeFileSystemBuilder()
                .IncludingDirectory(@"c:\folder")
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_enumerating_directories_for_missing_network_share_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_enumerating_directories_below_missing_network_share_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange

...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeDirectory
{
    public sealed class DirectoryMoveSpecs
    {
        [Theory]
        [CanRunOnFileSystem]
        private void When_moving_directory_for_null_source_it_must_fail(bool useFakes)
        {
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_moving_directory_for_null_destination_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_moving_directory_for_empty_string_source_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_moving_directory_for_empty_string_destination_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_moving_directory_for_whitespace_source_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_moving_directory_for_whitespace_destination_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        private void When_moving_directory_for_invalid_drive_source_it_must_fail()
        {
            ...
            // Act
            Action action = () => fileSystem.Directory.Move("_:", @"c:\newdir");
        ...
        private void When_moving_directory_for_invalid_drive_destination_it_must_fail()
        {
            ...
            // Act
            Action action = () => fileSystem.Directory.Move(@"c:\missing", "_:");
        ...
        private void When_moving_directory_that_contains_open_file_it_must_fail()
        {
            ...
            using (fileSystem.File.OpenRead(sourceFile))
            {
                ...
                // Assert
                action.Should().ThrowExactly<IOException>().WithMessage(@"Access to the path 'c:\existing-folder' is denied.");
            }
        }

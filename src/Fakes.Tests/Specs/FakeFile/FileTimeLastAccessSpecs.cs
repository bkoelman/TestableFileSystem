...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeFile
{
    public sealed class FileTimeLastAccessSpecs
    {
        ...
        [Fact, InvestigateRunOnFileSystem]
        private void When_getting_last_access_time_in_local_zone_for_file_below_missing_network_share_it_must_fail()
        {
            // Arrange
        ...
        [Fact, InvestigateRunOnFileSystem]
        private void When_setting_last_access_time_in_local_zone_for_file_below_missing_network_share_it_must_fail()
        {
            // Arrange
            string path = PathFactory.NetworkFileAtDepth(1);

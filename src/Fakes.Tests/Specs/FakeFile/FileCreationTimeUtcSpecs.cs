...
{
    public sealed class FileCreationTimeUtcSpecs
    {
        // TODO: Add similar set of tests for LastWriteTime and LastAccessTime. Consider local times.
        ...
        [Fact]
        private void When_getting_creation_time_in_UTC__for_invalid_characters_it_must_fail()
        {
            // Arrange
            IFileSystem fileSystem = new FakeFileSystemBuilder()
                .Build();
        ...
        private void When_setting_creation_time_in_UTC_for_existing_file_to_MaxValue_it_must_succeed()
        {
            ...
            // Act
            fileSystem.File.SetCreationTimeUtc(path, DateTime.MaxValue);

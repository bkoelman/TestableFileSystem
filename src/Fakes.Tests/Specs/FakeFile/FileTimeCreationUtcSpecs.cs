...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeFile
{
    public sealed class FileTimeCreationUtcSpecs
    {
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_getting_creation_time_in_UTC_for_null_it_must_fail(bool useFakes)
        {
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_setting_creation_time_in_UTC_for_null_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_getting_creation_time_in_UTC_for_empty_string_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_setting_creation_time_in_UTC_for_empty_string_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_getting_creation_time_in_UTC_for_whitespace_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_setting_creation_time_in_UTC_for_whitespace_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        private void When_getting_creation_time_in_UTC_for_invalid_drive_it_must_fail()
        {
            ...
            // Act
            Action action = () => fileSystem.File.GetCreationTimeUtc("_:");
        ...
        private void When_setting_creation_time_in_UTC_for_invalid_drive_it_must_fail()
        {
            ...
            // Act
            Action action = () => fileSystem.File.SetCreationTimeUtc("_:", DefaultTimeUtc);
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_getting_creation_time_in_UTC_for_missing_network_share_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_setting_creation_time_in_UTC_for_missing_network_share_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_getting_creation_time_in_UTC_for_file_below_missing_network_share_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_setting_creation_time_in_UTC_for_file_below_missing_network_share_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        private void When_setting_creation_time_in_UTC_for_existing_network_share_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange

...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeFile
{
    ...
    {
        [Fact]
        private void When_decrypting_file_for_null_it_must_fail()
        {
            // Arrange
        ...
        [Fact]
        private void When_decrypting_file_for_empty_string_it_must_fail()
        {
            // Arrange
            IFileSystem fileSystem = new FakeFileSystemBuilder()
                .Build();
        ...
        [Fact]
        private void When_decrypting_file_for_whitespace_it_must_fail()
        {
            // Arrange
            IFileSystem fileSystem = new FakeFileSystemBuilder()
                .Build();
        ...
        [Fact]
        private void When_decrypting_file_for_invalid_root_it_must_fail()
        {
            // Arrange
            IFileSystem fileSystem = new FakeFileSystemBuilder()
                .Build();
        ...
        [Fact]
        private void When_decrypting_file_for_invalid_characters_it_must_fail()
        {
            // Arrange
            IFileSystem fileSystem = new FakeFileSystemBuilder()
                .Build();
        ...
        private void When_decrypting_missing_local_file_it_must_fail()
        {
            ...
            // Assert
            action.Should().Throw<FileNotFoundException>().WithMessage(@"Could not find file 'c:\file.txt'.");
        }
        ...
        private void When_decrypting_file_on_missing_drive_it_must_fail()
        {
            ...
            action.Should().Throw<DirectoryNotFoundException>()
                .WithMessage(@"Could not find a part of the path 'z:\folder\file.txt'.");
        }
        ...
        private void When_decrypting_local_readonly_file_it_must_fail()
        {
            ...
            // Assert
            action.Should().Throw<IOException>().WithMessage("The specified file is read only.");
        }

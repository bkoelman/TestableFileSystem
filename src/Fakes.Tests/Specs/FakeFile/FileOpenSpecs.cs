...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeFile
{
    public sealed class FileOpenSpecs
    {
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_opening_file_for_empty_string_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_opening_file_for_whitespace_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_opening_missing_network_share_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange
        ...
        [Theory]
        [CanRunOnFileSystem]
        private void When_opening_file_on_missing_network_share_it_must_fail(bool useFakes)
        {
            using (var factory = new FileSystemBuilderFactory(useFakes))
            {
                // Arrange

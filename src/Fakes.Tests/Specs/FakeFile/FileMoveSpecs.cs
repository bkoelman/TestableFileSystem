...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeFile
{
    public sealed class FileMoveSpecs
    {
        ...
        private void When_moving_file_from_file_that_exists_as_directory_it_must_fail()
        {
            ...
            // Assert
            action.Should().Throw<FileNotFoundException>().WithMessage(@"Could not find file 'C:\some\subfolder'.");
        }
        ...
        private void When_moving_file_from_parent_directory_that_exists_as_file_it_must_fail()
        {
            ...
            // Assert
            action.Should().Throw<FileNotFoundException>().WithMessage(@"Could not find file 'C:\some\file.txt\other.txt'.");
        }
        ...
        private void When_moving_file_that_is_root_of_drive_it_must_fail()
        {
            ...
            // Assert
            action.Should().Throw<FileNotFoundException>().WithMessage(@"Could not find file 'C:\'.");
        }

...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeFileInfo
{
    public sealed class FileInfoTimeLastWriteSpecs
    {
        ...
        [Fact]
        private void When_getting_last_write_time_in_local_zone_it_must_lazy_load()
        {
            // Arrange
        ...
        [Fact]
        private void When_getting_last_write_time_in_local_zone_it_must_cache()
        {
            // Arrange
            const string path = @"c:\some\file.txt";
        ...
        [Fact]
        private void When_getting_last_write_time_in_local_zone_after_external_change_it_must_update_cache_on_refresh()
        {
            // Arrange
            const string path = @"c:\some\file.txt";
        ...
        [Fact]
        private void When_changing_last_write_time_in_local_zone_it_must_refresh_automatically()
        {
            // Arrange
            const string path = @"c:\some\file.txt";

...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeFileInfo
{
    public sealed class FileInfoTimeCreationUtcSpecs
    {
        ...
        [Fact]
        private void When_getting_file_creation_time_in_UTC_it_must_lazy_load()
        {
            // Arrange
        ...
        [Fact]
        private void When_getting_file_creation_time_in_UTC_after_external_change_it_must_update_cache_on_refresh()
        {
            // Arrange
            const string path = @"c:\some\file.txt";

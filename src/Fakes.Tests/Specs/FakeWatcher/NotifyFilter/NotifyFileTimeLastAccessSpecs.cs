...
{
    public sealed class NotifyFileTimeLastAccessSpecs : WatcherSpecs
    {
        private static readonly DateTime DefaultTimeUtc = 1.February(2003).At(12, 34, 56).AsUtc();

        [Fact]
        private void When_getting_file_last_access_time_in_local_zone_it_must_not_raise_events_for_all_notify_filters()
        {
            // Arrange
            ...
            using (FakeFileSystemWatcher watcher = fileSystem.ConstructFileSystemWatcher(directoryToWatch))
            {
                ...
                {
                    // Act
                    fileSystem.File.GetLastAccessTime(filePath);
        ...
        [Fact]
        private void When_changing_file_last_access_time_in_local_zone_it_must_raise_events_for_all_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            ...
            using (FakeFileSystemWatcher watcher = fileSystem.ConstructFileSystemWatcher(directoryToWatch))
            {
                ...
                {
                    // Act
                    fileSystem.File.SetLastAccessTime(filePath, DefaultTimeUtc.ToLocalTime());
        ...
        [Fact]
        private void When_changing_file_last_access_time_in_local_zone_it_must_raise_events_for_creation_time()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string fileName = "file.txt";
        ...
        [Fact]
        private void When_changing_file_last_access_time_in_local_zone_it_must_not_raise_events_for_other_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string fileName = "file.txt";
        ...
        [Fact]
        private void When_changing_file_last_access_time_in_local_zone_to_existing_value_it_must_raise_events_for_creation_time()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string fileName = "file.txt";

...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeWatcher.NotifyFilter
{
    public sealed class NotifyFileTimeLastWriteSpecs : WatcherSpecs
    {
        ...
        [Fact]
        private void When_getting_file_last_write_time_in_local_zone_it_must_not_raise_events()
        {
            // Arrange
        ...
        [WatcherNotifyTestData(@"
            * file.txt                                      @ LastWrite
        ")]
        private void When_changing_file_last_write_time_in_local_zone_it_must_raise_events(NotifyFilters filters,
        ...
        [WatcherNotifyTestData(@"
            * file.txt                                      @ LastWrite
        ")]
        private void When_changing_file_last_write_time_in_local_zone_to_existing_value_it_must_raise_events(

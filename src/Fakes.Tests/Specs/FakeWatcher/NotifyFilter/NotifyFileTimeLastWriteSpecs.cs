...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeWatcher.NotifyFilter
{
    public sealed class NotifyFileTimeLastWriteSpecs : WatcherSpecs
    {
        ...
        [Fact]
        private void When_getting_file_last_write_time_in_local_zone_it_must_not_raise_events_for_all_notify_filters()
        {
            // Arrange
            ...
            using (FakeFileSystemWatcher watcher = fileSystem.ConstructFileSystemWatcher(directoryToWatch))
            {
                ...
                {
                    // Act
                    fileSystem.File.GetLastWriteTime(filePath);
        ...
        [Fact]
        private void When_changing_file_last_write_time_in_local_zone_it_must_raise_events_for_all_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            ...
            using (FakeFileSystemWatcher watcher = fileSystem.ConstructFileSystemWatcher(directoryToWatch))
            {
                ...
                {
                    // Act
                    fileSystem.File.SetLastWriteTime(filePath, DefaultTimeUtc.ToLocalTime());
        ...
        [Fact]
        private void When_changing_file_last_write_time_in_local_zone_it_must_not_raise_events_for_other_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string fileName = "file.txt";
        ...
        [Fact]
        private void When_changing_file_last_write_time_in_local_zone_to_existing_value_it_must_raise_events_for_all_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string fileName = "file.txt";
        ...
        [Fact]
        private void When_changing_file_last_write_time_in_local_zone_to_existing_value_it_must_not_raise_events_for_other_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string fileName = "file.txt";

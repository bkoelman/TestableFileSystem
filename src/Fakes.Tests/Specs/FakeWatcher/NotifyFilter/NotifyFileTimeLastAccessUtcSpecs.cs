...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeWatcher.NotifyFilter
{
    public sealed class NotifyFileTimeLastAccessUtcSpecs : WatcherSpecs
    {
        ...
        [WatcherNotifyTestData(@"
            * file.txt                                      @ LastAccess
        ")]
        private void When_changing_file_last_access_time_in_UTC_it_must_raise_events(NotifyFilters filters,
        ...
        [WatcherNotifyTestData(@"
            * file.txt                                      @ LastAccess
        ")]
        private void When_changing_file_last_access_time_in_UTC_to_existing_value_it_must_raise_events(NotifyFilters filters,
            [NotNull] string expectedText)
        {
            // Arrange
            const string directoryToWatch = @"c:\some";

...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeWatcher.NotifyFilter
{
    public sealed class NotifyDirectoryTimeLastAccessUtcSpecs : WatcherSpecs
    {
        ...
        [Fact]
        private void When_getting_directory_last_access_time_in_UTC_it_must_not_raise_events()
        {
            // Arrange
        ...
        ")]
        private void When_changing_directory_last_access_time_in_UTC_it_must_raise_events(NotifyFilters filters,
        ...
        [WatcherNotifyTestData(@"
            * Subfolder                                     @ LastAccess
        ")]
        private void When_changing_directory_last_access_time_in_UTC_to_existing_value_it_must_raise_events(NotifyFilters filters,
            [NotNull] string expectedText)
        {
            // Arrange
            const string directoryToWatch = @"c:\some";

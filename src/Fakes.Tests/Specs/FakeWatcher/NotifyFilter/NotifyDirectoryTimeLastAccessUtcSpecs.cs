...
{
    public sealed class NotifyDirectoryTimeLastAccessUtcSpecs : WatcherSpecs
    {
        private static readonly DateTime DefaultTimeUtc = 1.February(2003).At(12, 34, 56).AsUtc();

        [Fact]
        private void When_getting_directory_last_access_time_in_UTC_it_must_not_raise_events_for_all_notify_filters()
        {
            // Arrange
        ...
        [Fact]
        private void When_changing_directory_last_access_time_in_UTC_it_must_raise_events_for_all_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
        ...
        [Fact]
        private void When_changing_directory_last_access_time_in_UTC_it_must_raise_events_for_last_access_time()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string directoryName = "Subfolder";
        ...
        [Fact]
        private void When_changing_directory_last_access_time_in_UTC_it_must_not_raise_events_for_other_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string directoryName = "Subfolder";
        ...
        [Fact]
        private void When_changing_directory_last_access_time_in_UTC_to_existing_value_it_must_raise_events_for_all_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string directoryName = "Subfolder";
        ...
        [Fact]
        private void When_changing_directory_last_access_time_in_UTC_to_existing_value_it_must_raise_events_for_last_access_time()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string directoryName = "Subfolder";
        ...
        [Fact]
        private void When_changing_directory_last_access_time_in_UTC_to_existing_value_it_must_not_raise_events_for_other_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string directoryName = "Subfolder";

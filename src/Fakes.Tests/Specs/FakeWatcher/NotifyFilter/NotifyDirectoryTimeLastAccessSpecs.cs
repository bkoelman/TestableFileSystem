...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeWatcher.NotifyFilter
{
    public sealed class NotifyDirectoryTimeLastAccessSpecs : WatcherSpecs
    {
        ...
        [Fact]
        private void When_changing_directory_last_access_time_in_local_zone_to_existing_value_it_must_raise_events_for_all_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string directoryName = "Subfolder";
        ...
        [Fact]
        private void When_changing_directory_last_access_time_in_local_zone_to_existing_value_it_must_raise_events_for_last_access_time()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string directoryName = "Subfolder";
        ...
        [Fact]
        private void When_changing_directory_last_access_time_in_local_zone_to_existing_value_it_must_not_raise_events_for_other_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string directoryName = "Subfolder";

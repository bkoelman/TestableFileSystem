...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeWatcher.NotifyFilter
{
    public sealed class NotifyFileTimeCreationSpecs : WatcherSpecs
    {
        ...
        [Fact]
        private void When_changing_file_creation_time_in_local_zone_to_existing_value_it_must_raise_events_for_all_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string fileName = "file.txt";
        ...
        [Fact]
        private void When_changing_file_creation_time_in_local_zone_to_existing_value_it_must_not_raise_events_for_other_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string fileName = "file.txt";

...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeWatcher.NotifyFilter
{
    public sealed class NotifyFileTimeCreationSpecs : WatcherSpecs
    {
        ...
        ")]
        private void When_changing_file_creation_time_in_local_zone_it_must_raise_events(NotifyFilters filters,
        ...
        [WatcherNotifyTestData(@"
            * file.txt                                      @ CreationTime
        ")]
        private void When_changing_file_creation_time_in_local_zone_to_existing_value_it_must_raise_events(NotifyFilters filters,
            [NotNull] string expectedText)
        {
            // Arrange
            const string directoryToWatch = @"c:\some";

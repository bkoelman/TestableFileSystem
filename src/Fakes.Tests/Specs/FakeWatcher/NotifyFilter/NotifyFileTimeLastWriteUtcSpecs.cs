...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeWatcher.NotifyFilter
{
    public sealed class NotifyFileTimeLastWriteUtcSpecs : WatcherSpecs
    {
        ...
        [Fact]
        private void When_changing_file_last_write_time_in_UTC_it_must_raise_events_for_creation_time()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string fileName = "file.txt";
        ...
        [Fact]
        private void When_changing_file_last_write_time_in_UTC_to_existing_value_it_must_raise_events_for_creation_time()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string fileName = "file.txt";
        ...
        [Fact]
        private void When_changing_file_last_write_time_in_UTC_to_existing_value_it_must_not_raise_events_for_other_notify_filters()
        {
            // Arrange
            const string directoryToWatch = @"c:\some";
            const string fileName = "file.txt";

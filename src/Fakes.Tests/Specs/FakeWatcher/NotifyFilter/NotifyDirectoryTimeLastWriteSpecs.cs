...
namespace TestableFileSystem.Fakes.Tests.Specs.FakeWatcher.NotifyFilter
{
    public sealed class NotifyDirectoryTimeLastWriteSpecs : WatcherSpecs
    {
        ...
        [Fact]
        private void When_getting_directory_last_write_time_in_local_zone_it_must_not_raise_events()
        {
            // Arrange
        ...
        [WatcherNotifyTestData(@"
            * Subfolder                                     @ LastWrite
        ")]
        private void When_changing_directory_last_write_time_in_local_zone_it_must_raise_events(NotifyFilters filters,
        ...
        [WatcherNotifyTestData(@"
            * Subfolder                                     @ LastWrite
        ")]
        private void When_changing_directory_last_write_time_in_local_zone_to_existing_value_it_must_raise_events(
